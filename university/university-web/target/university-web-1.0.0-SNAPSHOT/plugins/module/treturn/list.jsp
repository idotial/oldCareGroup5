 ...
 <!-- content start -->
  <div class="admin-content">
 	<div class="up-cf up-padding">
      <div class="up-fl up-cf"><strong class="up-text-primary up-text-lg">TReturn</strong> / <small>TReturn</small></div>
    </div>
      ...
      <div class="up-u-sm-12">
        <form class="up-form" method="post" name="list_form">
          ...
          <c:forEach items="${list}" var="rowdata" varStatus="status">
            <tr >
                            <td><input type="checkbox" name="ids" value="${rowdata.returnId}" /></td>
              													<td title="${rowdata.oldId}" > <a href="${basePath}${path}view/${rowdata.returnId}" class="name">${rowdata.oldId}</a></td>
                									
																			<td >${rowdata.classId}</td>
													
																		<td ><fmt:formatDate value="${rowdata.returnTime}" type="both" pattern="yyyy-MM-dd"/></td>
													
																			<td >${rowdata.returnState}</td>
