 ...
 <!-- content start -->
  <div class="admin-content">
 	<div class="up-cf up-padding">
      <div class="up-fl up-cf"><strong class="up-text-primary up-text-lg">TTime</strong> / <small>TTime</small></div>
    </div>
      ...
      <div class="up-u-sm-12">
        <form class="up-form" method="post" name="list_form">
          ...
          <c:forEach items="${list}" var="rowdata" varStatus="status">
            <tr >
                            <td><input type="checkbox" name="ids" value="${rowdata.timeId}" /></td>
