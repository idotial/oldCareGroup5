...
<div class="admin-content">
	<div class="up-cf up-padding">
		<div class="up-fl up-cf">
			<strong class="up-text-primary up-text-lg">TChange</strong> / <small>TChange</small>
		</div>
	</div>
						...
						<c:forEach items="${list}" var="rowdata" varStatus="status">
							<tr>
								<td><input type="checkbox" name="ids"
									value="${rowdata.changeId}" /></td>
								<td title="${rowdata.oldId}"><a
									href="${basePath}${path}view/${rowdata.changeId}" class="name">${rowdata.oldId}</a></td>
