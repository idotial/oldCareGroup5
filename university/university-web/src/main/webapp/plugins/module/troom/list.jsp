 ...
 <!-- content start -->
  <div class="admin-content">
 	<div class="up-cf up-padding">
      <div class="up-fl up-cf"><strong class="up-text-primary up-text-lg">TRoom</strong> / <small>TRoom</small></div>
    </div>
      ...
      <div class="up-u-sm-12">
        <form class="up-form" method="post" name="list_form">
          ...
          <c:forEach items="${list}" var="rowdata" varStatus="status">
            <tr >
                            <td><input type="checkbox" name="ids" value="${rowdata.roomId}" /></td>
              													<td title="${rowdata.position}" > <a href="${basePath}${path}view/${rowdata.roomId}" class="name">${rowdata.position}</a></td>
