 ...
 <!-- content start -->
  <div class="admin-content">
 	<div class="up-cf up-padding">
      <div class="up-fl up-cf"><strong class="up-text-primary up-text-lg">TTerm</strong> / <small>TTerm</small></div>
    </div>
      ...
      <div class="up-u-sm-12">
        <form class="up-form" method="post" name="list_form">
          ...
          <c:forEach items="${list}" var="rowdata" varStatus="status">
            <tr >
                            <td><input type="checkbox" name="ids" value="${rowdata.termId}" /></td>
              													<td title="${rowdata.termName}" > <a href="${basePath}${path}view/${rowdata.termId}" class="name">${rowdata.termName}</a></td>
                									
																		<td ><fmt:formatDate value="${rowdata.startData}" type="both" pattern="yyyy-MM-dd"/></td>
													
																		<td ><fmt:formatDate value="${rowdata.endData}" type="both" pattern="yyyy-MM-dd"/></td>
