 ...
 <!-- content start -->
  <div class="admin-content">
 	<div class="up-cf up-padding">
      <div class="up-fl up-cf"><strong class="up-text-primary up-text-lg">TClass</strong> / <small>TClass</small></div>
    </div>
          ...
          <c:forEach items="${list}" var="rowdata" varStatus="status">
            <tr >
                            <td><input type="checkbox" name="ids" value="${rowdata.classId}" /></td>
              													<td title="${rowdata.courseId}" > <a href="${basePath}${path}view/${rowdata.classId}" class="name">${rowdata.courseId}</a></td>
