		...
		<div class="container">
	        ...
	        <div class="box">
	          <div class="box_border">
	            <div class="box_top"><b class="pl15">TAdmin</b></div>
	              ...
	              <input type="hidden" id="pageNum" name="pageNum" value="${page.pageNum}"/>
	               ...
	               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>	
					 					 ...
					 					 <td class=""><input id="createTime" name="createTime"  type="text" class="input-text lh30" 
					 						 		value="<fmt:formatDate value="${model.createTime}" type="both" pattern="yyyy-MM-dd"/>" data-up-datepicker="{format: 'yyyy-mm-dd'}" readonly />
					 						</td>
					
															 <td class="td_right">更改时间</td>
					 					 <td class=""><input id="changeTime" name="changeTime"  type="text" class="input-text lh30" 
					 						 		value="<fmt:formatDate value="${model.changeTime}" type="both" pattern="yyyy-MM-dd"/>" data-up-datepicker="{format: 'yyyy-mm-dd'}" readonly />
					 						</td>
					
									</tr>
															 <td class="td_right">power</td>
					 					 <td class=""><input id="power" name="power"  type="text" class="input-text lh30" 
					 						 		value="${model.power}" />	
					 						</td>
